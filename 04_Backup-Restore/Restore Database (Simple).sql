...
FROM DISK = N'" + @BackupPath + BackupFileName + "_1.bak'
DISK = N'" + @BackupPath + BackupFileName + "_2.bak'
DISK = N'" + @BackupPath + BackupFileName + "_3.bak'
DISK = N'" + @BackupPath + BackupFileName + "_4.bak'
WITH"
+ CASE 
    WHEN @UseReplace = 1 THEN " REPLACE,"
    ELSE ""
  END
+ CASE
    WHEN @UseMove = 1 THEN ", MOVE N'" + DataLogicalName + "' TO N'" + DataFolder + TargetDatabaseName + "'.mdf, MOVE N'" + LogLogicalName + "' TO N'" + LogFolder + TargetDatabaseName + "'.ldf"
    ELSE ""
  END
+ " RECOVERY, STATS = 10;
GO  " AS RestoreCommand
FROM @tDatabases
