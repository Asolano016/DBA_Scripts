...
DECLARE @numDays INT = 365; --Backup report range
...
WHERE rh.destination_database_name NOT IN ('master','msdb','model','Admin')
AND rh.restore_date >= DATEADD(DAY,-@numDays,GETDATE())
