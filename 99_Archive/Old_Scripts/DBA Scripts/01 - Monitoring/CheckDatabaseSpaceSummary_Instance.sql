...
SELECT
    ...
    CAST(fa.TotalSizeGB                                 AS DECIMAL(18,4)) AS TotalSizeGB,
    -- Internal space
    CASE fa.type_desc
        WHEN 'ROWS' THEN CAST(di.UsedGB                AS DECIMAL(18,4))
        WHEN 'LOG'  THEN CAST(li.UsedGB                AS DECIMAL(18,4))
    END                                                             AS InternalUsedGB,
    CASE fa.type_desc
        WHEN 'ROWS' THEN CAST(di.FreeGB                AS DECIMAL(18,4))
        WHEN 'LOG'  THEN CAST(li.FreeGB                AS DECIMAL(18,4))
