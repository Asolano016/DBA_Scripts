...
AddSpaceDbMb - rec|ts according to filling (based on statistics, for small files or filling up to 24%, for large files or filling more than 10%, on average around 15%).
