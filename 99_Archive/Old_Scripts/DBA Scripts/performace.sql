...
--~
	...
	declare @delta_interval TINYINT = 3
	...
	declare @get_plans TINYINT = 1

	--Get the associated outer ad hoc query or stored procedure call, if available
	declare @get_outer_command BIT = 1

	--Enables pulling transaction log write info and transaction duration
	declare @get_transaction_info BIT = 1
	...
	declare @get_task_info TINYINT = 2
